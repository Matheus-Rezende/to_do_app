...
class ApiClient {
  ...
  Future<Result<List<TodoModel>>> getTodos() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        //Possivel erro pode acontecer aqui!
        final List<TodoModel> todos = json.map((todo) => TodoModel.fromJson(todo)).toList();
  ...
  Future<Result<TodoModel>> getTodoById(String id) async {
    final client = _clientHttpFactory();
  ...
  Future<Result<TodoModel>> postTodo(CreateApiTodoModel todo) async {
    final client = _clientHttpFactory();
  ...
  Future<Result<TodoModel>> updateTodo(UpdateApiTodoModel todo) async {
    final client = _clientHttpFactory();
  ...
  Future<Result<void>> deleteTodo(TodoModel todo) async {
    final client = _clientHttpFactory();
